...
for logo in vrgl117_logo n64brew_jam_logo; do
    for n in 1 2 3 4 5 6 7 8 9; do
        convert -strip -brightness-contrast -$((100 - n * 10)) "resources/gfx/sprites/intro/$logo.png" "resources/gfx/sprites/intro/${logo}_${n}.png"
    done
done
